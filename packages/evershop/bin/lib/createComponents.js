...
module.exports.createComponents = async function createComponents(
  ...
  await Promise.all(
    routes.map(async (route) => {
      ...
      import Area from '@ANNAPOORANI/ANNAPOORANI/src/lib/components/Area';
      `;
      if (isProductionMode()) {
        contentClient += `import Hydrate from '@ANNAPOORANI/ANNAPOORANI/src/lib/components/react/client/Hydrate';`;
      } else {
        contentClient += `import { App } from '@ANNAPOORANI/ANNAPOORANI/src/lib/components/react/client/Client';
      const hot = require('webpack-hot-middleware/client?path=/eHot/${route.id}&reload=true');
      import { HotReload } from '@ANNAPOORANI/ANNAPOORANI/src/lib/components/react/client/HotReload';
      `;
      }
      contentClient += '\r\n';
      ...
      if (!clientOnly) {
        ...
        contentServer += '\r\n';
        contentServer += `import Area from '@ANNAPOORANI/ANNAPOORANI/src/lib/components/Area';`;
        contentServer += '\r\n';
